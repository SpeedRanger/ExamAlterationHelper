...
public class update_request extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blocke = findViewById(R.id.block_edit_req);
        roome = findViewById(R.id.room_edit_req);
        namee = findViewById(R.id.name_edit_req);
        timee = findViewById(R.id.time_edit_req);
        datee = findViewById(R.id.date_edit_req);
